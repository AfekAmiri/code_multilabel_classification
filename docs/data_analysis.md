...
- **Variable target :**
    ...
    - Focus sur les tags principaux : **math, graphs, strings, number theory, trees, geometry, games, probabilities**
        ...
        - Densité : 0.159
        - Diversité : 77
    - ![Distribution des tags filtrés](_assets/images/filtered_tag_distribution.png)
...
- **Analyse des valeurs manquantes :**
    ...
    - ![Matrice des NaN](_assets/images/nana_matrix.png)
    - ![Pourcentage de NaN par colonne](_assets/images/nana_percentage_per_column.png)
...
- ![Boxplot de difficulty par tag](_assets/images/box_plot_difficulty_pr_tag.png)
...
- Dépendance entre tags et difficulty
    ...
    - ![Boxplot de difficulty par tag](_assets/images/box_plot_diffivulty_per_tag.png)
